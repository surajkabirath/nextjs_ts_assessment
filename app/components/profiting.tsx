...
const Profiting = () => {
  return (
    <section className="pt-20 pb-40 justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
    <div className="site_container mx-auto p-4 w-full">
      ...
      <div className="profiting_block_wrap flex  items-center">
        ...
        <div className="profiting_block_content w-full max-w-md md:w-[397px] md:h-[500px] self-center ">
